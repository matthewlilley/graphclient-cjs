...
export type MeshContext = LegacyTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/legacy/introspectionSchema":
      return import("./sources/legacy/introspectionSchema") as T;
...
export type getLiquidityPositionsQueryVariables = Exact<{
  skip?: InputMaybe<Scalars['Int']>;
  first?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<LiquidityPosition_filter>;
}>;
...
export type getLiquidityPositionsQuery = { liquidityPositions: Array<Pick<LiquidityPosition, 'id'>> };
...
export const getLiquidityPositionsDocument = gql`
  ...
  liquidityPositions(skip: $skip, first: $first, where: $where) {
    ...
    ` as unknown as DocumentNode<getLiquidityPositionsQuery, getLiquidityPositionsQueryVariables>;
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    getLiquidityPositions(variables?: getLiquidityPositionsQueryVariables, options?: C): Promise<getLiquidityPositionsQuery> {
      return requester<getLiquidityPositionsQuery, getLiquidityPositionsQueryVariables>(getLiquidityPositionsDocument, variables, options) as Promise<getLiquidityPositionsQuery>;
    }
  };
}
